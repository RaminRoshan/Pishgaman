...
use Pishgaman\Pishgaman\Http\Controllers\Web\messagesController;
...
Route::namespace('Pishgaman\Pishgaman\Http\Controllers\Web')->middleware('web')->group(function () {
    ...
    Route::get('downloadMsgAttachment', [DownloadController::class, 'downloadMsgAttachment'])->name('downloadMsgAttachment')->middleware('auth');
